 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ch="FirebaseError";class He extends Error{constructor(e,t,n){super(t),this.code=e,this.customData=n,this.name=Ch,Object.setPrototypeOf(this,He.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Fn.prototype.create)}}class Fn{constructor(e,t,n){this.service=e,this.serviceName=t,this.errors=n}create(e,...t){const n=t[0]||{},i=`${this.service}/${e}`,o=this.errors[e],a=o?Ph(o,n):"Error",c=`${this.serviceName}: ${a} (${i}).`;return new He(i,c,n)}}function Ph(r,e){return r.replace(kh,(t,n)=>{const i=e[n];return i!=null?String(i):`<${n}?>`})}const kh=/\{\$([^}]+)}/g;function Dh(r){for(const e in r)if(Object.prototype.hasOwnProperty.call(r,e))return!1;return!0}function Pr(r,e){if(r===e)return!0;const t=Object.keys(r),n=Object.keys(e);for(const i of t){if(!n.includes(i))return!1;const o=r[i],a=e[i];if(oa(o)&&oa(a)){if(!Pr(o,a))return!1}else if(o!==a)return!1}for(const i of n)if(!t.includes(i))return!1;return!0}function oa(r){return r!==null&&typeof r=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xt=Cd;function Pu(r,e={}){let t=r;typeof e!="object"&&(e={name:e});const n=Object.assign({name:Wi,automaticDataCollectionEnabled:!1},e),i=n.name;if(typeof i!="string"||!i)throw ot.create("bad-app-name",{appName:String(i)});if(t||(t=Ru()),!t)throw ot.create("no-options");const o=kr.get(i);if(o){if(Pr(t,o.options)&&Pr(n,o.config))return o;throw ot.create("duplicate-app",{appName:i})}const a=new Uh(i);for(const h of Qi.values())a.addComponent(h);const c=new Vd(t,n,a);return kr.set(i,c),c}function ku(r=Wi){const e=kr.get(r);if(!e&&r===Wi&&Ru())return Pu();if(!e)throw ot.create("no-app",{appName:r});return e}function at(r,e,t){var n;let i=(n=Pd[r])!==null&&n!==void 0?n:r;t&&(i+=`-${t}`);const o=i.match(/\s|\//),a=e.match(/\s|\//);if(o||a){const c=[`Unable to register library "${i}" with version "${e}":`];o&&c.push(`library name "${i}" contains illegal characters (whitespace or "/")`),o&&a&&c.push("and"),a&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),je.warn(c.join(" "));return}jt(new At(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Nd="firebase-heartbeat-database",Od=1,Nn="firebase-heartbeat-store";let Mi=null;function Du(){return Mi||(Mi=Xh(Nd,Od,{upgrade:(r,e)=>{switch(e){case 0:try{r.createObjectStore(Nn)}catch(t){console.warn(t)}}}}).catch(r=>{throw ot.create("idb-open",{originalErrorMessage:r.message})})),Mi}async function Ld(r){try{const t=(await Du()).transaction(Nn),n=await t.objectStore(Nn).get(Vu(r));return await t.done,n}catch(e){if(e instanceof He)je.warn(e.message);else{const t=ot.create("idb-get",{originalErrorMessage:e?.message});je.warn(t.message)}}}async function da(r,e){try{const n=(await Du()).transaction(Nn,"readwrite");await n.objectStore(Nn).put(e,Vu(r)),await n.done}catch(t){if(t instanceof He)je.warn(t.message);else{const n=ot.create("idb-set",{originalErrorMessage:t?.message});je.warn(n.message)}}}function Vu(r){return`${r.name}!${r.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qd(r){jt(new At("platform-logger",e=>new ed(e),"PRIVATE")),jt(new At("heartbeat",e=>new Ud(e),"PRIVATE")),at(Ki,la,r),at(Ki,la,"esm2017"),at("fire-js","")}qd("");var jd="firebase",zd="11.2.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */at(jd,zd,"app");function Is(r,e){var t={};for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&e.indexOf(n)<0&&(t[n]=r[n]);if(r!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,n=Object.getOwnPropertySymbols(r);i<n.length;i++)e.indexOf(n[i])<0&&Object.prototype.propertyIsEnumerable.call(r,n[i])&&(t[n[i]]=r[n[i]]);return t}function Nu(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const $d=Nu,Ou=new Fn("auth","Firebase",Nu());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dr=new _s("@firebase/auth");function Gd(r,...e){Dr.logLevel<=F.WARN&&Dr.warn(`Auth (${Xt}): ${r}`,...e)}function Er(r,...e){Dr.logLevel<=F.ERROR&&Dr.error(`Auth (${Xt}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ze(r,...e){throw Ts(r,...e)}function Ve(r,...e){return Ts(r,...e)}function Lu(r,e,t){const n=Object.assign(Object.assign({},$d()),{[e]:t});return new Fn("auth","Firebase",n).create(e,{appName:r.name})}function vt(r){return Lu(r,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Ts(r,...e){if(typeof r!="string"){const t=e[0],n=[...e.slice(1)];return n[0]&&(n[0].appName=r.name),r._errorFactory.create(t,...n)}return Ou.create(r,...e)}function L(r,e,...t){if(!r)throw Ts(e,...t)}function Fe(r){const e="INTERNAL ASSERTION FAILED: "+r;throw Er(e),new Error(e)}function $e(r,e){r||Fe(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qn{constructor(e,t){this.shortDelay=e,this.longDelay=t,$e(t>e,"Short delay should be less than long delay!"),this.isMobile=Eh()||wh()}get(){return Kd()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vs(r,e){$e(r.emulator,"Emulator should always be set here");const{url:t}=r.emulator;return e?`${t}${e.startsWith("/")?e.slice(1):e}`:t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jd=new qn(3e4,6e4);function ws(r,e){return r.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:r.tenantId}):e}async function Yt(r,e,t,n,i={}){return xu(r,i,async()=>{let o={},a={};n&&(e==="GET"?a=n:o={body:JSON.stringify(n)});const c=Bn(Object.assign({key:r.config.apiKey},a)).slice(1),h=await r._getAdditionalHeaders();h["Content-Type"]="application/json",r.languageCode&&(h["X-Firebase-Locale"]=r.languageCode);const f=Object.assign({method:e,headers:h},o);return Th()||(f.referrerPolicy="no-referrer"),Mu.fetch()(Uu(r,r.config.apiHost,t,c),f)})}async function xu(r,e,t){r._canInitEmulator=!1;const n=Object.assign(Object.assign({},Qd),e);try{const i=new Yd(r),o=await Promise.race([t(),i.promise]);i.clearNetworkTimeout();const a=await o.json();if("needConfirmation"in a)throw fr(r,"account-exists-with-different-credential",a);if(o.ok&&!("errorMessage"in a))return a;{const c=o.ok?a.errorMessage:a.error.message,[h,f]=c.split(" : ");if(h==="FEDERATED_USER_ID_ALREADY_LINKED")throw fr(r,"credential-already-in-use",a);if(h==="EMAIL_EXISTS")throw fr(r,"email-already-in-use",a);if(h==="USER_DISABLED")throw fr(r,"user-disabled",a);const p=n[h]||h.toLowerCase().replace(/[_\s]+/g,"-");if(f)throw Lu(r,p,f);ze(r,p)}}catch(i){if(i instanceof He)throw i;ze(r,"network-request-failed",{message:String(i)})}}async function Xd(r,e,t,n,i={}){const o=await Yt(r,e,t,n,i);return"mfaPendingCredential"in o&&ze(r,"multi-factor-auth-required",{_serverResponse:o}),o}function Uu(r,e,t,n){const i=`${e}${t}?${n}`;return r.config.emulator?vs(r.config,i):`${r.config.apiScheme}://${i}`}class Yd{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,n)=>{this.timer=setTimeout(()=>n(Ve(this.auth,"network-request-failed")),Jd.get())})}}function fr(r,e,t){const n={appName:r.name};t.email&&(n.email=t.email),t.phoneNumber&&(n.phoneNumber=t.phoneNumber);const i=Ve(r,e,n);return i.customData._tokenResponse=t,i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function On(r,e,t=!1){if(t)return e;try{return await e}catch(n){throw n instanceof He&&tf(n)&&r.auth.currentUser===r&&await r.auth.signOut(),n}}function tf({code:r}){return r==="auth/user-disabled"||r==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _a=new Map;function qe(r){$e(r instanceof Function,"Expected a class definition");let e=_a.get(r);return e?($e(e instanceof r,"Instance stored in cache mismatched with class"),e):(e=new r,_a.set(r,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ir(r,e,t){return`firebase:${r}:${e}:${t}`}class Ut{constructor(e,t,n){this.persistence=e,this.auth=t,this.userKey=n;const{config:i,name:o}=this.auth;this.fullUserKey=Ir(this.userKey,i.apiKey,o),this.fullPersistenceKey=Ir("persistence",i.apiKey,o),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?Be._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,n="authUser"){if(!t.length)return new Ut(qe(ya),e,n);const i=(await Promise.all(t.map(async f=>{if(await f._isAvailable())return f}))).filter(f=>f);let o=i[0]||qe(ya);const a=Ir(n,e.config.apiKey,e.name);let c=null;for(const f of t)try{const p=await f._get(a);if(p){const v=Be._fromJSON(e,p);f!==o&&(c=v),o=f;break}}catch{}const h=i.filter(f=>f._shouldAllowMigration);return!o._shouldAllowMigration||!h.length?new Ut(o,e,n):(o=h[0],c&&await o._set(a,c.toJSON()),await Promise.all(t.map(async f=>{if(f!==o)try{await f._remove(a)}catch{}})),new Ut(o,e,n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ea(r){const e=r.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Gu(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(ju(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Ku(e))return"Blackberry";if(Wu(e))return"Webos";if(zu(e))return"Safari";if((e.includes("chrome/")||$u(e))&&!e.includes("edge/"))return"Chrome";if(Hu(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=r.match(t);if(n?.length===2)return n[1]}return"Other"}function ju(r=Ie()){return/firefox\//i.test(r)}function zu(r=Ie()){const e=r.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function $u(r=Ie()){return/crios\//i.test(r)}function Gu(r=Ie()){return/iemobile/i.test(r)}function Hu(r=Ie()){return/android/i.test(r)}function Ku(r=Ie()){return/blackberry/i.test(r)}function Wu(r=Ie()){return/webos/i.test(r)}function Rs(r=Ie()){return/iphone|ipad|ipod/i.test(r)||/macintosh/i.test(r)&&/mobile/i.test(r)}function uf(r=Ie()){var e;return Rs(r)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function cf(){return Ah()&&document.documentMode===10}function Qu(r=Ie()){return Rs(r)||Hu(r)||Wu(r)||Ku(r)||/windows phone/i.test(r)||Gu(r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jn extends Zu{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nr extends He{constructor(e,t,n,i){var o;super(t.code,t.message),this.operationType=n,this.user=i,Object.setPrototypeOf(this,Nr.prototype),this.customData={appName:e.name,tenantId:(o=e.tenantId)!==null&&o!==void 0?o:void 0,_serverResponse:t.customData._serverResponse,operationType:n}}static _fromErrorAndOperation(e,t,n,i){return new Nr(e,t,n,i)}}function ec(r,e,t,n){return(e==="reauthenticate"?t._getReauthenticationResolver(r):t._getIdTokenResponse(r)).catch(o=>{throw o.code==="auth/multi-factor-auth-required"?Nr._fromErrorAndOperation(r,o,e,n):o})}async function Rf(r,e,t=!1){const n=await On(r,e._linkToIdToken(r.auth,await r.getIdToken()),t);return zt._forOperation(r,"link",n)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sf(r,e,t=!1){const{auth:n}=r;if(nt(n.app))return Promise.reject(vt(n));const i="reauthenticate";try{const o=await On(r,ec(n,i,e,r),t);L(o.idToken,n,"internal-error");const a=As(o.idToken);L(a,n,"internal-error");const{sub:c}=a;return L(r.uid===c,n,"user-mismatch"),zt._forOperation(r,i,o)}catch(o){throw o?.code==="auth/user-not-found"&&ze(n,"user-mismatch"),o}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bf(r,e,t=!1){if(nt(r.app))return Promise.reject(vt(r));const n="signIn",i=await ec(r,n,e),o=await zt._fromIdTokenResponse(r,n,i);return t||await r._updateCurrentUser(o.user),o}function Cf(r,e,t,n){return be(r).onIdTokenChanged(e,t,n)}function Pf(r,e,t){return be(r).beforeAuthStateChanged(e,t)}function kf(r,e,t,n){return be(r).onAuthStateChanged(e,t,n)}const Or="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tc{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(Or,"1"),this.storage.removeItem(Or),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oc="firebaseLocalStorageDb",Bf=1,Lr="firebaseLocalStorage",ac="fbase_key";class zn{constructor(e){this.request=e}toPromise(){return new Promise((e,t)=>{this.request.addEventListener("success",()=>{e(this.request.result)}),this.request.addEventListener("error",()=>{t(this.request.error)})})}}function Kr(r,e){return r.transaction([Lr],e?"readwrite":"readonly").objectStore(Lr)}function qf(){const r=indexedDB.deleteDatabase(oc);return new zn(r).toPromise()}function Yi(){const r=indexedDB.open(oc,Bf);return new Promise((e,t)=>{r.addEventListener("error",()=>{t(r.error)}),r.addEventListener("upgradeneeded",()=>{const n=r.result;try{n.createObjectStore(Lr,{keyPath:ac})}catch(i){t(i)}}),r.addEventListener("success",async()=>{const n=r.result;n.objectStoreNames.contains(Lr)?e(n):(n.close(),await qf(),e(await Yi()))})})}async function wa(r,e,t){const n=Kr(r,!0).put({[ac]:e,value:t});return new zn(n).toPromise()}async function jf(r,e){const t=Kr(r,!1).get(e),n=await new zn(t).toPromise();return n===void 0?null:n.value}function Aa(r,e){const t=Kr(r,!0).delete(e);return new zn(t).toPromise()}const zf=800,$f=3;class uc{constructor(){this.type="LOCAL",this._shouldAllowMigration=!0,this.listeners={},this.localCache={},this.pollTimer=null,this.pendingWrites=0,this.receiver=null,this.sender=null,this.serviceWorkerReceiverAvailable=!1,this.activeServiceWorker=null,this._workerInitializationPromise=this.initializeServiceWorkerMessaging().then(()=>{},()=>{})}async _openDb(){return this.db?this.db:(this.db=await Yi(),this.db)}async _withRetries(e){let t=0;for(;;)try{const n=await this._openDb();return await e(n)}catch(n){if(t++>$f)throw n;this.db&&(this.db.close(),this.db=void 0)}}async initializeServiceWorkerMessaging(){return sc()?this.initializeReceiver():this.initializeSender()}async initializeReceiver(){this.receiver=Hr._getInstance(Ff()),this.receiver._subscribe("keyChanged",async(e,t)=>({keyProcessed:(await this._poll()).includes(t.key)})),this.receiver._subscribe("ping",async(e,t)=>["keyChanged"])}async initializeSender(){var e,t;if(this.activeServiceWorker=await xf(),!this.activeServiceWorker)return;this.sender=new Lf(this.activeServiceWorker);const n=await this.sender._send("ping",{},800);n&&!((e=n[0])===null||e===void 0)&&e.fulfilled&&!((t=n[0])===null||t===void 0)&&t.value.includes("keyChanged")&&(this.serviceWorkerReceiverAvailable=!0)}async notifyServiceWorker(e){if(!(!this.sender||!this.activeServiceWorker||Uf()!==this.activeServiceWorker))try{await this.sender._send("keyChanged",{key:e},this.serviceWorkerReceiverAvailable?800:50)}catch{}}async _isAvailable(){try{if(!indexedDB)return!1;const e=await Yi();return await wa(e,Or,"1"),await Aa(e,Or),!0}catch{}return!1}async _withPendingWrite(e){this.pendingWrites++;try{await e()}finally{this.pendingWrites--}}async _set(e,t){return this._withPendingWrite(async()=>(await this._withRetries(n=>wa(n,e,t)),this.localCache[e]=t,this.notifyServiceWorker(e)))}async _get(e){const t=await this._withRetries(n=>jf(n,e));return this.localCache[e]=t,t}async _remove(e){return this._withPendingWrite(async()=>(await this._withRetries(t=>Aa(t,e)),delete this.localCache[e],this.notifyServiceWorker(e)))}async _poll(){const e=await this._withRetries(i=>{const o=Kr(i,!1).getAll();return new zn(o).toPromise()});if(!e)return[];if(this.pendingWrites!==0)return[];const t=[],n=new Set;if(e.length!==0)for(const{fbase_key:i,value:o}of e)n.add(i),JSON.stringify(this.localCache[i])!==JSON.stringify(o)&&(this.notifyListeners(i,o),t.push(i));for(const i of Object.keys(this.localCache))this.localCache[i]&&!n.has(i)&&(this.notifyListeners(i,null),t.push(i));return t}notifyListeners(e,t){this.localCache[e]=t;const n=this.listeners[e];if(n)for(const i of Array.from(n))i(t)}startPolling(){this.stopPolling(),this.pollTimer=setInterval(async()=>this._poll(),zf)}stopPolling(){this.pollTimer&&(clearInterval(this.pollTimer),this.pollTimer=null)}_addListener(e,t){Object.keys(this.listeners).length===0&&this.startPolling(),this.listeners[e]||(this.listeners[e]=new Set,this._get(e)),this.listeners[e].add(t)}_removeListener(e,t){this.listeners[e]&&(this.listeners[e].delete(t),this.listeners[e].size===0&&delete this.listeners[e]),Object.keys(this.listeners).length===0&&this.stopPolling()}}uc.type="LOCAL";const Gf=uc;new qn(3e4,6e4);/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xf="pendingRedirect",Tr=new Map;class Yf extends cc{constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}async execute(){let e=Tr.get(this.auth._key());if(!e){try{const n=await Zf(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(n)}catch(t){e=()=>Promise.reject(t)}Tr.set(this.auth._key(),e)}return this.bypassAuthState||Tr.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Zf(r,e){const t=np(e),n=tp(r);if(!await n._isAvailable())return!1;const i=await n._get(t)==="true";return await n._remove(t),i}function ep(r,e){Tr.set(r._key(),e)}function tp(r){return qe(r._redirectPersistence)}function np(r){return Ir(Xf,r.config.apiKey,r.name)}async function rp(r,e,t=!1){if(nt(r.app))return Promise.reject(vt(r));const n=Ss(r),i=Hf(n,e),a=await new Yf(n,i,t).execute();return a&&!t&&(delete a.user._redirectEventId,await n._persistUserIfCurrent(a.user),await n._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dp=new qn(3e4,6e4);function Sa(){const r=Ne().___jsl;if(r?.H){for(const e of Object.keys(r.H))if(r.H[e].r=r.H[e].r||[],r.H[e].L=r.H[e].L||[],r.H[e].r=[...r.H[e].L],r.CP)for(let t=0;t<r.CP.length;t++)r.CP[t]=null}}function fp(r){return new Promise((e,t)=>{var n,i,o;function a(){Sa(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Sa(),t(Ve(r,"network-request-failed"))},timeout:dp.get()})}if(!((i=(n=Ne().gapi)===null||n===void 0?void 0:n.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((o=Ne().gapi)===null||o===void 0)&&o.load)a();else{const c=yf("iframefcb");return Ne()[c]=()=>{gapi.load?a():t(Ve(r,"network-request-failed"))},gf(`${_f()}?onload=${c}`).catch(h=>t(h))}}).catch(e=>{throw vr=null,e})}let vr=null;function pp(r){return vr=vr||fp(r),vr}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ui="webStorageSupport";class Np{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=ic,this._completeRedirectFn=rp,this._overrideRedirectResult=ep}async _openPopup(e,t,n,i){var o;$e((o=this.eventManagers[e._key()])===null||o===void 0?void 0:o.manager,"_initialize() not called before _openPopup()");const a=await Ca(e,t,n,Ji(),i);return bp(e,a,Cs())}async _openRedirect(e,t,n,i){await this._originValidation(e);const o=await Ca(e,t,n,Ji(),i);return Mf(o),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:i,promise:o}=this.eventManagers[t];return i?Promise.resolve(i):($e(o,"If manager is not set, promise should be"),o)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch(()=>{delete this.eventManagers[t]}),n}async initAndGetManager(e){const t=await Tp(e),n=new sp(e);return t.register("authEvent",i=>(L(i?.authEvent,e,"invalid-auth-event"),{status:n.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Ui,{type:Ui},i=>{var o;const a=(o=i?.[0])===null||o===void 0?void 0:o[Ui];a!==void 0&&t(!!a),ze(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=lp(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Qu()||zu()||Rs()}}const Op=Np;var Pa="@firebase/auth",ka="1.8.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const St=new _s("@firebase/firestore");function Vt(){return St.logLevel}function k(r,...e){if(St.logLevel<=F.DEBUG){const t=e.map(ks);St.debug(`Firestore (${Zt}): ${r}`,...t)}}function Ge(r,...e){if(St.logLevel<=F.ERROR){const t=e.map(ks);St.error(`Firestore (${Zt}): ${r}`,...t)}}function $t(r,...e){if(St.logLevel<=F.WARN){const t=e.map(ks);St.warn(`Firestore (${Zt}): ${r}`,...t)}}function ks(r){if(typeof r=="string")return r;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xr{constructor(e,t){this.position=e,this.inclusive=t}}function ja(r,e,t){let n=0;for(let i=0;i<r.position.length;i++){const o=e[i],a=r.position[i];if(o.field.isKeyField()?n=O.comparator(O.fromName(a.referenceValue),t.key):n=Ht(a,t.data.field(o.field)),o.dir==="desc"&&(n*=-1),n!==0)break}return n}function za(r,e){if(r===null)return e===null;if(e===null||r.inclusive!==e.inclusive||r.position.length!==e.position.length)return!1;for(let t=0;t<r.position.length;t++)if(!Le(r.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ur{constructor(e,t="asc"){this.field=e,this.dir=t}}function hm(r,e){return r.dir===e.dir&&r.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ms(r,e){if(r.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Mr(e)?"-0":e}}function Vc(r){return{integerValue:""+r}}function km(r,e){return im(e)?Vc(e):Ms(r,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ni{constructor(e,t,n,i,o){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=i,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(e,t,n){const i=new Map;return i.set(e,Gn.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new ni(x.min(),i,new re(q),mt(),z())}}class Gn{constructor(e,t,n,i,o){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=i,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(e,t,n){return new Gn(n,t,z(),z(),z())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bs{constructor(){this.Er=new oe(ae.Ar),this.Rr=new oe(ae.Vr)}isEmpty(){return this.Er.isEmpty()}addReference(e,t){const n=new ae(e,t);this.Er=this.Er.add(n),this.Rr=this.Rr.add(n)}mr(e,t){e.forEach(n=>this.addReference(n,t))}removeReference(e,t){this.gr(new ae(e,t))}pr(e,t){e.forEach(n=>this.removeReference(n,t))}yr(e){const t=new O(new Q([])),n=new ae(t,e),i=new ae(t,e+1),o=[];return this.Rr.forEachInRange([n,i],a=>{this.gr(a),o.push(a.key)}),o}wr(){this.Er.forEach(e=>this.gr(e))}gr(e){this.Er=this.Er.delete(e),this.Rr=this.Rr.delete(e)}Sr(e){const t=new O(new Q([])),n=new ae(t,e),i=new ae(t,e+1);let o=z();return this.Rr.forEachInRange([n,i],a=>{o=o.add(a.key)}),o}containsKey(e){const t=new ae(e,0),n=this.Er.firstAfterOrEqual(t);return n!==null&&e.isEqual(n.key)}}class ae{constructor(e,t){this.key=e,this.br=t}static Ar(e,t){return O.comparator(e.key,t.key)||q(e.br,t.br)}static Vr(e,t){return q(e.br,t.br)||O.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class js{constructor(e,t,n,i){this.targetId=e,this.fromCache=t,this.Wi=n,this.Gi=i}static zi(e,t){let n=z(),i=z();for(const o of t.docChanges)switch(o.type){case 0:n=n.add(o.doc.key);break;case 1:i=i.add(o.doc.key)}return new js(e,t.fromCache,n,i)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ug{constructor(e,t,n,i,o){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.B_=[],this.L_=new Map,this.k_=new Set,this.q_=[],this.Q_=o,this.Q_.uo(a=>{n.enqueueAndForget(async()=>{Kn(this)&&(k("RemoteStore","Restarting streams for network reachability change."),await async function(h){const f=j(h);f.k_.add(4),await Hn(f),f.K_.set("Unknown"),f.k_.delete(4),await ii(f)}(this))})}),this.K_=new xg(n,i)}}async function ii(r){if(Kn(r))for(const e of r.q_)await e(!0)}async function Hn(r){for(const e of r.q_)await e(!1)}function Zc(r,e){const t=j(r);t.L_.has(e.targetId)||(t.L_.set(e.targetId,e),Hs(t)?Gs(t):nn(t).s_()&&$s(t,e))}function zs(r,e){const t=j(r),n=nn(t);t.L_.delete(e),n.s_()&&el(t,e),t.L_.size===0&&(n.s_()?n.a_():Kn(t)&&t.K_.set("Unknown"))}function $s(r,e){if(r.U_.xe(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(x.min())>0){const t=r.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}nn(r).V_(e)}function el(r,e){r.U_.xe(e),nn(r).m_(e)}function Gs(r){r.U_=new jm({getRemoteKeysForTarget:e=>r.remoteSyncer.getRemoteKeysForTarget(e),ut:e=>r.L_.get(e)||null,nt:()=>r.datastore.serializer.databaseId}),nn(r).start(),r.K_.F_()}function Hs(r){return Kn(r)&&!nn(r).i_()&&r.L_.size>0}function Kn(r){return j(r).k_.size===0}function tl(r){r.U_=void 0}async function Fg(r){r.K_.set("Online")}async function Bg(r){r.L_.forEach((e,t)=>{$s(r,e)})}async function qg(r,e){tl(r),Hs(r)?(r.K_.O_(e),Gs(r)):r.K_.set("Unknown")}async function jg(r,e,t){if(r.K_.set("Online"),e instanceof Bc&&e.state===2&&e.cause)try{await async function(i,o){const a=o.cause;for(const c of o.targetIds)i.L_.has(c)&&(await i.remoteSyncer.rejectListen(c,a),i.L_.delete(c),i.U_.removeTarget(c))}(r,e)}catch(n){k("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),n),await ou(r,n)}else if(e instanceof Sr?r.U_.$e(e):e instanceof Fc?r.U_.Je(e):r.U_.Ge(e),!t.isEqual(x.min()))try{const n=await Xc(r.localStore);t.compareTo(n)>=0&&await function(o,a){const c=o.U_.it(a);return c.targetChanges.forEach((h,f)=>{if(h.resumeToken.approximateByteSize()>0){const p=o.L_.get(f);p&&o.L_.set(f,p.withResumeToken(h.resumeToken,a))}}),c.targetMismatches.forEach((h,f)=>{const p=o.L_.get(h);if(!p)return;o.L_.set(h,p.withResumeToken(he.EMPTY_BYTE_STRING,p.snapshotVersion)),el(o,h);const v=new it(p.target,h,f,p.sequenceNumber);$s(o,v)}),o.remoteSyncer.applyRemoteEvent(c)}(r,t)}catch(n){k("RemoteStore","Failed to raise snapshot:",n),await ou(r,n)}}async function ou(r,e,t){if(!en(e))throw e;r.k_.add(1),await Hn(r),r.K_.set("Offline"),t||(t=()=>Xc(r.localStore)),r.asyncQueue.enqueueRetryable(async()=>{k("RemoteStore","Retrying IndexedDB access"),await t(),r.k_.delete(1),await ii(r)})}async function au(r,e){const t=j(r);t.asyncQueue.verifyOperationInProgress(),k("RemoteStore","RemoteStore received new credentials");const n=Kn(t);t.k_.add(3),await Hn(t),n&&t.K_.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.k_.delete(3),await ii(t)}async function zg(r,e){const t=j(r);e?(t.k_.delete(2),await ii(t)):e||(t.k_.add(2),await Hn(t),t.K_.set("Unknown"))}function nn(r){return r.W_||(r.W_=function(t,n,i){const o=j(t);return o.b_(),new Lg(n,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,i)}(r.datastore,r.asyncQueue,{Ro:Fg.bind(null,r),mo:Bg.bind(null,r),po:qg.bind(null,r),R_:jg.bind(null,r)}),r.q_.push(async e=>{e?(r.W_.__(),Hs(r)?Gs(r):r.K_.set("Unknown")):(await r.W_.stop(),tl(r))})),r.W_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sn{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class Al extends vl{constructor(e,t,n,i,o,a){super(e,t,n,i,a),this._firestore=e,this._firestoreImpl=e,this.metadata=o}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new br(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const n=this._document.data.field(to("DocumentSnapshot.get",e));if(n!==null)return this._userDataWriter.convertValue(n,t.serverTimestamps)}}}class br extends Al{data(e={}){return super.data(e)}}class k_{constructor(e,t,n,i){this._firestore=e,this._userDataWriter=t,this._snapshot=i,this.metadata=new Sn(i.hasPendingWrites,i.fromCache),this.query=n}get docs(){const e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,t){this._snapshot.docs.forEach(n=>{e.call(t,new br(this._firestore,this._userDataWriter,n.key,n,new Sn(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new D(b.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(i,o){if(i._snapshot.oldDocs.isEmpty()){let a=0;return i._snapshot.docChanges.map(c=>{const h=new br(i._firestore,i._userDataWriter,c.doc.key,c.doc,new Sn(i._snapshot.mutatedKeys.has(c.doc.key),i._snapshot.fromCache),i.query.converter);return c.doc,{type:"added",doc:h,oldIndex:-1,newIndex:a++}})}{let a=i._snapshot.oldDocs;return i._snapshot.docChanges.filter(c=>o||c.type!==3).map(c=>{const h=new br(i._firestore,i._userDataWriter,c.doc.key,c.doc,new Sn(i._snapshot.mutatedKeys.has(c.doc.key),i._snapshot.fromCache),i.query.converter);let f=-1,p=-1;return c.type!==0&&(f=a.indexOf(c.doc.key),a=a.delete(c.doc.key)),c.type!==1&&(a=a.add(c.doc),p=a.indexOf(c.doc.key)),{type:D_(c.type),doc:h,oldIndex:f,newIndex:p}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}function D_(r){switch(r){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return U()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function V_(r){r=Un(r,Re);const e=Un(r.firestore,Js);return h_(_l(e),r._key).then(t=>N_(e,r,t))}class Rl extends P_{constructor(e){super(),this.firestore=e}convertBytes(e){return new Jt(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Re(this.firestore,null,t)}}function Sl(r){r=Un(r,rn);const e=Un(r.firestore,Js),t=_l(e),n=new Rl(e);return b_(r._query),d_(t,r._query).then(i=>new k_(e,n,r,i))}function N_(r,e,t){const n=t.docs.get(e._key),i=new Rl(r);return new Al(r,i,e._key,n,new Sn(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){(function(i){Zt=i})(Xt),jt(new At("firestore",(n,{instanceIdentifier:i,options:o})=>{const a=n.getProvider("app").getImmediate(),c=new Js(new Gp(n.getProvider("auth-internal")),new Qp(n.getProvider("app-check-internal")),function(f,p){if(!Object.prototype.hasOwnProperty.apply(f.options,["projectId"]))throw new D(b.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Mn(f.options.projectId,p)}(a,i),a);return o=Object.assign({useFetchStreams:t},o),c._setSettings(o),c},"PUBLIC").setMultipleInstances(!0)),at(Na,"4.7.6",e),at(Na,"4.7.6","esm2017")})();let $i,Vn,$r;try{const r={apiKey:"AIzaSyB1dlHRhLA71PxCgVLjOieUcUF22DWx6zY",authDomain:"autonomy-heroes.firebaseapp.com",projectId:"autonomy-heroes",storageBucket:"autonomy-heroes.firebasestorage.app",messagingSenderId:"266526530869",appId:"1:266526530869:web:ea95143735be497ca8007c",measurementId:"G-70PG5B4S39"},e=["apiKey","authDomain","projectId"];for(const t of e)if(!r[t])throw new Error(`Missing required Firebase config key: ${t}`);$i=Pu(r),Vn=qp($i),$r=g_($i)}catch(r){throw console.error("Firebase initialization failed:",r),new Error("Failed to initialize Firebase: "+r.message)}class bl{async logout(){try{await Vn.signOut(),document.getElementById("authContainer").classList.add("active"),document.getElementById("adminDashboard").style.display="none"}catch(e){console.error("Error during logout:",e),alert("Failed to log out. Please try again.")}}initialize(e){kf(Vn,async t=>{this.user=t,t?(this.role=await this.getUserRole(t.uid),e(t,this.role)):e(null,null)})}async getUserRole(e){try{const t=m_($r,"users",e),n=await V_(t);return n.exists()?n.data().role||"worker":(console.error("User document not found"),null)}catch(t){return console.error("Error fetching user role:",t),null}}async logout(){try{await Vn.signOut(),window.location.href="/login"}catch(e){console.error("Error during logout:",e),alert("Failed to log out. Please try again.")}}}class X{static createElement(e,t={}){const n=document.createElement(e);return t.text&&(n.textContent=t.text),t.className&&(n.className=t.className),t.attributes&&Object.keys(t.attributes).forEach(i=>{n.setAttribute(i,t.attributes[i])}),n}static removeAllChildren(e){for(;e.firstChild;)e.removeChild(e.firstChild)}static appendChildren(e,t){t.forEach(n=>e.appendChild(n))}static toggleVisibility(e,t,n="hidden"){t?e.classList.remove(n):e.classList.add(n)}}class O_{constructor(e,t,n=[]){this.db=e,this.role=t,this.assignedWorkers=n,this.entries=[]}async loadEntries(){try{const e=this.role==="manager"?gs(zr(this.db,"timeEntries"),Rn("workerId","in",this.assignedWorkers)):gs(zr(this.db,"timeEntries")),t=await Sl(e);this.entries=t.docs.map(n=>({id:n.id,...n.data()}))}catch(e){console.error("Failed to load time entries:",e)}}render(e){if(!e)throw new Error("Container is required.");const t=X.createTable(["Date","Worker","Hours","Status","Actions"]);this.entries.forEach(n=>{const i=X.createTableRow([DateUtils.formatDate(new Date(n.date)),n.workerId,n.hours,n.status||"Pending"]),o=X.createElement("td");o.appendChild(X.createButton("Approve",()=>this.updateStatus(n.id,"approved"))),o.appendChild(X.createButton("Reject",()=>this.updateStatus(n.id,"rejected"))),i.appendChild(o),t.appendChild(i)}),e.appendChild(t)}async updateStatus(e,t){try{await updateDoc(doc(this.db,"timeEntries",e),{status:t}),alert(`Entry ${t}.`)}catch(n){console.error("Error updating entry:",n),alert("Update failed.")}}}class L_{constructor(e){if(!Array.isArray(e))throw new Error("A valid companies array is required.");this.companies=e,this.generatedInvoices=[]}async fetchApprovedEntries(e,t,n){try{const i=DateUtils.normalizeDate(t).toISOString(),o=DateUtils.normalizeDate(n).toISOString(),a=gs(zr($r,"timeEntries"),Rn("companyId","==",e),Rn("status","==","approved"),Rn("date",">=",i),Rn("date","<=",o));return(await Sl(a)).docs.map(h=>h.data())}catch(i){return console.error("Failed to fetch approved entries:",i),[]}}async generateInvoice(e,t,n,i){try{const o=await this.fetchApprovedEntries(e,n,i);if(!o.length){alert("No approved time entries found.");return}const a=o.reduce((f,p)=>f+p.hours,0),c={companyId:e,companyName:t,startDate:n.toISOString(),endDate:i.toISOString(),totalHours:a,generatedAt:serverTimestamp()},h=await addDoc(zr($r,"invoices"),c);this.generatedInvoices.push({...c,id:h.id}),this.renderInvoicesList(),alert(`Invoice for ${t} generated successfully.`)}catch(o){console.error("Error generating invoice:",o),alert("Invoice generation failed.")}}render(e){if(!e)throw new Error("A valid container is required.");X.removeAllChildren(e);const t=X.createForm(),n=X.createDropdown(this.companies,"Select Company"),i=X.createDateInput("Start Date"),o=X.createDateInput("End Date"),a=X.createButton("Generate Invoice");t.append(n,i,o,a),e.appendChild(t),t.addEventListener("submit",async c=>{c.preventDefault();const h=n.value,f=this.companies.find(R=>R.id===h)?.name,p=new Date(i.value),v=new Date(o.value);if(!h||!p||!v){alert("Invalid input.");return}await this.generateInvoice(h,f,p,v)}),this.renderInvoicesList(e)}renderInvoicesList(e){if(X.clearContainer(e),!this.generatedInvoices.length){e.textContent="No invoices available.";return}const t=X.createElement("ul");this.generatedInvoices.forEach(n=>{const i=X.createElement("li",{text:`${n.companyName}: ${n.totalHours} hrs (${n.startDate} - ${n.endDate})`});t.appendChild(i)}),e.appendChild(t)}}class M_{constructor(){this.state={user:null,role:null,timeEntries:[],companies:[],error:null},this.subscribers=[]}setState(e,t){this.state[e]=t,this.notifySubscribers()}getState(e){return this.state[e]}subscribe(e){this.subscribers.push(e)}notifySubscribers(){this.subscribers.forEach(e=>e(this.state))}}class x_{static hasAccess(e,t){return t.includes(e)}}class U_{constructor(){this.timeEntriesTable=null,this.invoiceGenerator=null,this.state=new M_,this.authManager=new bl}renderDashboard(e,t){if(this.state.setState("user",e),this.state.setState("role",t),!x_.hasAccess(t,["manager","super-admin"])){window.location.href="/hours";return}const n=document.getElementById("adminDashboard");if(!n)throw new Error("Dashboard container not found");X.removeAllChildren(n);const i=X.createElement("h1",{text:`Welcome, ${e.email}`,className:"welcome-message"});n.appendChild(i);const o=X.createElement("button",{text:"Logout",className:"btn-logout"});o.addEventListener("click",()=>this.authManager.logout()),n.appendChild(o);const a=X.createElement("div",{id:"errorBoundary",className:"error-boundary",attributes:{"aria-hidden":!0}});n.appendChild(a);const c=X.createElement("section",{className:"time-entries-section"});if(n.appendChild(c),this.timeEntriesTable=new O_(t),this.timeEntriesTable.render(c),t==="super-admin"){const h=X.createElement("section",{className:"invoice-section"});n.appendChild(h),this.invoiceGenerator=new L_,this.invoiceGenerator.render(h)}this.state.subscribe(h=>{console.log("State updated:",h),h.error&&this.showError(h.error)})}showError(e){const t=document.getElementById("errorBoundary");if(t){X.removeAllChildren(t);const n=X.createElement("p",{text:e,className:"error-message"}),i=X.createElement("button",{text:"Retry",className:"btn-primary"});i.addEventListener("click",()=>{t.setAttribute("aria-hidden",!0),this.state.setState("error",null)}),t.appendChild(n),t.appendChild(i),t.setAttribute("aria-hidden",!1)}}destroy(){this.timeEntriesTable&&(this.timeEntriesTable.destroy(),this.timeEntriesTable=null),this.invoiceGenerator&&(this.invoiceGenerator.destroy(),this.invoiceGenerator=null)}enableRealTimeUpdates(){if(!this.state.getState("role")){console.warn("Role is not set. Cannot enable real-time updates.");return}const e=this.state.getState("role");this.timeEntriesTable.enableRealTimeUpdates(e)}}class F_{constructor(){this.dashboardRenderer=null,this.authManager=null,this.initialized=!1}async initialize(){try{this.authManager=new bl,this.setupAuthStateListener(),this.setupErrorHandling()}catch(e){console.error("Failed to initialize admin app:",e),this.showError("Application initialization failed")}}setupAuthStateListener(){Vn.onAuthStateChanged(async e=>{try{await this.handleAuthStateChange(e)}catch(t){console.error("Auth state change error:",t),this.showError("Authentication error occurred")}})}async handleAuthStateChange(e){const t=document.getElementById("appLoading");t&&(t.style.display="none"),await this.cleanup(),e?(console.log("User authenticated:",e.email),await this.initializeDashboard(e)):document.getElementById("authContainer").classList.add("active")}async cleanup(){this.dashboardRenderer&&(this.dashboardRenderer.destroy(),this.dashboardRenderer=null),this.initialized=!1}async initializeDashboard(e){try{const t=await this.authManager.getUserRole(e.uid);this.dashboardRenderer=new U_,this.dashboardRenderer.renderDashboard(e,t),document.getElementById("authContainer").classList.remove("active"),this.initialized=!0}catch(t){console.error("Failed to initialize dashboard:",t),this.showError("Failed to initialize dashboard")}}setupErrorHandling(){window.addEventListener("unhandledrejection",e=>{console.error("Unhandled promise rejection:",e.reason),this.showError("An unexpected error occurred")}),window.addEventListener("error",e=>{console.error("Global error:",e.error),this.showError("An unexpected error occurred")})}showError(e){const t=document.getElementById("errorBoundary"),n=document.getElementById("errorMessage");t&&n&&(t.style.display="block",n.textContent=e)}}document.addEventListener("DOMContentLoaded",async()=>{await new F_().initialize()});
